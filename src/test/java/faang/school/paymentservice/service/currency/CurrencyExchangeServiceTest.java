...
import faang.school.paymentservice.client.exchange.OpenExchangeRatesClient;
...
class CurrencyExchangeServiceTest {
    ...
    public void testConvertCurrency_UsdPayment_ReturnsOriginalAmount() {
        PaymentRequest usdPayment = createPaymentRequest("USD", new BigDecimal("100.00"));
    ...
    void testConvertCurrency_EUR() {
        ...
        PaymentRequest request = createPaymentRequest("EUR", new BigDecimal("100.00"));
    ...
    public void testConvertCurrency_UnsupportedCurrency_ThrowsException() {
        PaymentRequest unsupportedPayment = createPaymentRequest("XYZ", new BigDecimal("100.00"));
    ...
    public void testConvertCurrency_ExternalApiFailure_ThrowsException() {
        PaymentRequest eurPayment = createPaymentRequest("EUR", new BigDecimal("100.00"));
        when(exchangeRatesClient.getLatestRates(anyString()))
    ...
    private PaymentRequest createPaymentRequest(String currencyCode, BigDecimal amount) {
